...
function getDatabaseUrl() {
  const possibleUrls = [
    ...
    process.env.DATABASE_KickCounter_POSTGRES_URL,
    process.env.DATABASE_KickCounter_POSTGRES_URL_NON_POOLING,
    process.env.DATABASE_KickCounter_POSTGRES_URL_NO_SSL,
  ...
  if (!validUrl) {
    throw new Error(
      'Database URL is missing or invalid. Check Vercel Environment Variables.'
    );
  }
